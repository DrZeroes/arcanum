...
const itemsData = {
    ...
    "AM01": {
        ...
        type: "arme_melee", rarete: "2", poids: 3.0, prix: 15,
    ...
    "AM04": {
        ...
        type: "arme_melee", rarete: "3", poids: 0.5, prix: 10,
    ...
    "AM05": {
        ...
        type: "arme_melee", rarete: "2", poids: 1.5, prix: 5,
    ...
    "AM06": {
        ...
        type: "arme_melee", rarete: "4", poids: 2.5, prix: 40,
    ...
    "AM07": {
        ...
        type: "arme_melee", rarete: "1", poids: 0.5, prix: 2,
    ...
    "AM10": {
        ...
        type: "arme_melee", rarete: "4", poids: 3.5, prix: 35,
    ...
    "AD01": {
        ...
        type: "arme_distance", rarete: "3", poids: 1.5, prix: 40,
    ...
    "AD02": {
        ...
        type: "arme_distance", rarete: "4", poids: 1.0, prix: 30,
	...
	"AF02": {
        ...
        type: "arme_feu", rarete: "3", poids: 1.8, prix: 350,
        equipable: "main_droite", stackable: false, degats: "5-15", armure: 0, vitesse: 15, portee: 12,
    ...
    "DEF01": {
        ...
        type: "armure", rarete: "2", poids: 1.0, prix: 15,
    ...
    "DEF02": {
        ...
        type: "armure", rarete: "4", poids: 4.0, prix: 60,
    ...
    "DEF03": {
        ...
        type: "armure", rarete: "8", poids: 3.5, prix: 850,
    ...
    "DEF04": {
        ...
        type: "armure", rarete: "1", poids: 1.0, prix: 20,
        equipable: "torse", stackable: false, degats: "0", armure: 1, vitesse: 0, portee: 0,
        stats: {}, prerequis: {}, alignement: 0, nbUsages: null
    },
    "DEF05": {
        nom: "Veste en tissu", desc: "Une veste épaisse d'ouvrier.",
        type: "armure", rarete: "1", poids: 1.2, prix: 25,
    ...
    "DEF06": {
        ...
        type: "armure", rarete: "1", poids: 1.0, prix: 5,
    ...
    "DEF09": {
        ...
        type: "armure", rarete: "5", poids: 5.0, prix: 120,
    ...
    "DEF10": {
        ...
        type: "armure", rarete: "6", poids: 1.0, prix: 250,
        equipable: "torse", stackable: false, degats: "0", armure: 2, vitesse: 0, portee: 0,
    ...
    "DEF11": {
        ...
        type: "armure", rarete: "4", poids: 2.5, prix: 50,
    ...
    "CONS01": {
        ...
        type: "consommable", rarete: "6", poids: 0.5, prix: 45,
    ...
    "CONS02": {
        ...
        type: "consommable", rarete: "7", poids: 1.0, prix: 100,
    ...
    "CONS03": {
        ...
        type: "consommable", rarete: "3", poids: 0.5, prix: 25,
        equipable: "aucun", stackable: true, degats: "0", armure: 0, vitesse: 0, portee: 0,
    ...
    "CONS04": {
        ...
        type: "consommable", rarete: "3", poids: 0.5, prix: 20,
        equipable: "aucun", stackable: true, degats: "0", armure: 0, vitesse: 0, portee: 0,
   ...
   "XXX01": {
    ...
    "XXX04": {
        ...
        desc: "Un médaillon en argent terni gravé d'un blason oublié. Il dégage une faible chaleur constante.",
