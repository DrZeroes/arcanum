...
const ennemisData = {
    ...
    "guerrier_ork": {
        nom: "Guerrier Ork", niveau: 8,
        race: "Ork",
        statsBase: {FO:13, CN:10, DX:9, IN:5, CH:5},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/guerrier_ork.png",
    ...
    "chaman_ork": {
        nom: "Chaman Ork", niveau: 15,
        race: "Ork",
        statsBase: {FO:10, CN:9, DX:7, IN:12, CH:6, MA:30},
        statsInvesties: {}, compInvesties: {},
        magieBase: {"Nature":3, "Transformation":1},
        portrait: "npc-ennemis/monstres/chaman_ork.png",
        pvActuel: 60, ftActuel: 58, boostPV: 28, boostFT: 28,
        equipement: {tete:null, torse:{id:"DEF48"}, gants:null, bottes:null, anneau:null, amulette:null, main_droite:{id:"AM22"}, main_gauche:null},
        xp: 375, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:4, proba:1}, {id:"TEC03", qte:1, proba:0.4}, {id:"CONS07", qte:1, proba:0.5}, {id:"CONS22", qte:1, proba:0.3}],
        resistances: {resPhys:10, resMagie:20, resFeu:10, resPoison:10, resElec:10}
    },
    ...
    "krag_lesser": {
        nom: "Krag", niveau: 4,
        race: "Krag",
        statsBase: {FO:10, CN:8, DX:7, IN:3, CH:2},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/krag_lesser.png",
        pvActuel: 28, ftActuel: 26, boostPV: 10, boostFT: 10,
        equipement: {tete:null, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:null, main_gauche:null},
        xp: 100, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:1, proba:0.5}],
        resistances: {resPhys:20, resMagie:5, resFeu:10, resPoison:10, resElec:5}
    },

    // Créé par IA - stats estimées
    "krag_warrior": {
        nom: "Guerrier Krag", niveau: 8,
        race: "Krag",
        statsBase: {FO:13, CN:10, DX:9, IN:3, CH:2},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/krag_warrior.png",
        pvActuel: 44, ftActuel: 40, boostPV: 18, boostFT: 18,
        equipement: {tete:null, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:null, main_gauche:null},
        xp: 200, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:2, proba:0.7}, {id:"COMP14", qte:1, proba:0.3}],
        resistances: {resPhys:25, resMagie:5, resFeu:10, resPoison:10, resElec:5}
    },

    // Créé par IA - stats estimées
    "krag_berserker": {
        nom: "Berserk Krag", niveau: 12,
        race: "Krag",
        statsBase: {FO:16, CN:11, DX:11, IN:3, CH:2},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/krag_berserker.png",
        pvActuel: 58, ftActuel: 52, boostPV: 26, boostFT: 24,
        equipement: {tete:null, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:{id:"AM37"}, main_gauche:null},
        xp: 300, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:3, proba:0.7}, {id:"COMP14", qte:1, proba:0.4}],
        resistances: {resPhys:30, resMagie:5, resFeu:10, resPoison:10, resElec:5}
    },

    // Créé par IA - stats estimées
    "krag_shaman": {
        nom: "Chaman Krag", niveau: 10,
        race: "Krag",
        statsBase: {FO:7, CN:8, DX:7, IN:12, CH:4, MA:20},
        statsInvesties: {}, compInvesties: {},
        magieBase: {"Nature":2},
        portrait: "npc-ennemis/monstres/krag_shaman.png",
        pvActuel: 44, ftActuel: 50, boostPV: 16, boostFT: 24,
        equipement: {tete:null, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:null, main_gauche:null},
        xp: 250, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:2, proba:0.7}, {id:"COMP05", qte:1, proba:0.5}, {id:"TEC03", qte:1, proba:0.3}],
        resistances: {resPhys:15, resMagie:20, resFeu:10, resPoison:10, resElec:10}
    },

    // Créé par IA - stats estimées
    "krag_chieftain": {
        nom: "Chef Krag", niveau: 18,
        race: "Krag",
        statsBase: {FO:17, CN:13, DX:12, IN:7, CH:6},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/krag_chieftain.png",
        pvActuel: 74, ftActuel: 70, boostPV: 38, boostFT: 36,
        equipement: {tete:{id:"DEF19"}, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:{id:"AM10"}, main_gauche:null},
        xp: 450, argent: 0,
        lootDrop: [{id:"OR_PIECES", qte:5, proba:0.8}, {id:"COMP14", qte:1, proba:0.5}, {id:"CONS03", qte:1, proba:0.3}],
        resistances: {resPhys:35, resMagie:10, resFeu:10, resPoison:10, resElec:5}
    },
    ...
    // Créé par IA - stats estimées
    "kuljin": {
        nom: "Kuljin", niveau: 6, race: "Humain",
        statsBase: {FO:8, CN:7, DX:10, IN:6, CH:4},
        statsInvesties: {}, compInvesties: {},
        portrait: "npc-ennemis/monstres/kuljin.png",
        pvActuel: 36, ftActuel: 42, boostPV: 12, boostFT: 14,
        equipement: {tete:null, torse:null, gants:null, bottes:null, anneau:null, amulette:null, main_droite:null, main_gauche:null},
        xp: 160, argent: 15,
        lootDrop: [{id:"TEC03", qte:1, proba:0.25}, {id:"COMP50", qte:1, proba:0.2}],
        resistances: {resPhys:10, resMagie:5, resFeu:0, resPoison:0, resElec:0},
        zones: ["Tarant", "Arcanum"]
    },
    // Créé par IA - stats estimées
    "hollow_man": {
